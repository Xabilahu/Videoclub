...
Public Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False And usuario <> "" Then 'Solamente se hace cuando vaya a esta página
            '*****************************************************************************************
            ' CUANDO SE REGISTRA UN NUEVO USUARIO SE LE DA AUTOMÁTICAMENTE DE ALTA COMO SOCIO EN LA BD
            '*****************************************************************************************
            ...
            'Insertamos el usuario en la tabla SOCIO si no existe --> EJEMPLO DE INSTRUCCIÓN CON UN PARÁMETRO
            Dim strSQL As String = "INSERT INTO SOCIO(usuarioLogin) VALUES (?)"
            ...
            Try
                ...
                MsgBox("Se ha dado de alta a un nuevo socio")
