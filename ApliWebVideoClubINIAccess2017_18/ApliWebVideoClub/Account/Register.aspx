<%@ Page Title="Registrarse" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="Register.aspx.vb" Inherits="ApliWebVideoClub.Register" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Nombre de usuario para el login:</asp:Label>
                                <asp:TextBox ID="UserName" runat="server" CssClass="textEntry"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" 
                                     CssClass="failureNotification" ErrorMessage="El número de socio es obligatorio." ToolTip="El número de socio es obligatorio." 
